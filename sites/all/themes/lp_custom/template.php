 ...
 */
function lp_custom_admin_links_info_alter(&$info) {
 ...
 */
function lp_custom_css_alter(&$css) {
 ...
 */
function lp_custom_preprocess_html(&$variables, $hook) {
 ...
 */
function lp_custom_preprocess_page(&$variables) {
