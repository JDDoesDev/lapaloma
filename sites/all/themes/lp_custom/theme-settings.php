 ...
 */
function lp_custom_form_system_theme_settings_alter(&$form, &$form_state) {
  $theme_path = drupal_get_path('theme', 'lp_custom');
  ...
  $form['#submit'][] = 'lp_custom_form_variable_realm_variable_theme_form_submit';
 ...
 */
function lp_custom_form_variable_realm_variable_theme_form_submit($form, &$form_state) {
